...
**OOP School Library** is a command line tool for decoding morse code
...
- **Add new students or teachers to a database**
- **Add new books to a database**
- **Save records of who borrowed a given book and when in a database**
...
```sh
  cd my-folder
  git clone git@github.com:Juank628/OOP_school_library.git
```
...
Feel free to check the [issues page](https://github.com/Juank628/OOP_school_library/issues).
